...
class Solution:
    ...
    # dict, 72ms, 23.4mb, 时间o(n), 空间o(n), input remains intact
    ...
    # set, 68ms, 23.4mb, 时间o(n), 空间o(n), input remains intact
    ...
    # sort, 88ms, 23.4mb, 时间o(nlogn), 空间o(1), input remains intact   
    ...
    # pigeonhole principle, 80ms, 23.4mb, 时间o(n), 空间o(1), input changes  
...
if __name__ == '__main__':
    ...
    for item in input:
        ...
        print(s.findRepeatNumber4(item))
        print('-----')